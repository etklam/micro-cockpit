...
verify_secret db-credentials \
  ...
  MARKET_DATA_DB_PASSWORD TOOL_DB_PASSWORD || failed=1
verify_secret service-connection-strings \
  IDENTITY_CONNECTION_STRING JOURNAL_CONNECTION_STRING MARKET_DATA_CONNECTION_STRING \
  TOOL_CONNECTION_STRING || failed=1
