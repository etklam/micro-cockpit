...
const bootstrapSchema = {
  type: 'object',
  required: ['currentUser', 'timezone', 'baseCurrency', 'appearance', 'locale', 'accentTheme', 'role', 'accountType', 'currentLocalDate', 'availableProductAreas'],
  properties: {
    currentUser: {
      type: 'object', required: ['id', 'email', 'displayName'],
      properties: { id: { type: 'string', format: 'uuid' }, email: { type: 'string' }, displayName: { type: 'string' } },
    },
    timezone: { type: 'string' }, baseCurrency: { type: 'string' }, appearance: { type: 'string' }, locale: { type: 'string' }, accentTheme: { type: 'string' },
