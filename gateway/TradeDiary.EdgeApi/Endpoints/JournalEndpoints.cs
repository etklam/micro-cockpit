internal static class JournalEndpoints
{
    internal static void Map(WebApplication app)
    {
        ...
        EdgeTransport.MapProxy(app, "/api/app/diaries/{diaryId:guid}/transactions/{id:guid}", "journal", "/internal/diaries/{diaryId}/transactions/{id}", [HttpMethods.Get, HttpMethods.Put, HttpMethods.Delete]).RequireAuthorization("diaryAccess");
