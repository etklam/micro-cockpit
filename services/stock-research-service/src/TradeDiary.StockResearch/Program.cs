...
builder.Services.AddSingleton(_ => NpgsqlDataSource.Create(builder.Configuration.GetConnectionString("StockResearch") ?? throw new InvalidOperationException("Connection string 'StockResearch' is required.")));
