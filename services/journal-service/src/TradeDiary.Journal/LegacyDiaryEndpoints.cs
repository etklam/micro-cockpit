...
// LEGACY — the pre-repositioning Diary/Transaction/Review/Partner surface.
// Slated for removal in issue 14 (Market Observation cutover). Kept in one file so
// retirement is a single deletion: drop this file, its Edge proxies, and the legacy tables.
// Do not add new routes here; new domains get their own endpoint module.
static class LegacyDiaryEndpoints
{
    internal static void Map(RouteGroupBuilder diary)
    {
