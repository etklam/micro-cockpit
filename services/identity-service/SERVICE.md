...
- Registration has three explicit modes: public when `Auth__AllowPublicRegistration=true`, key-gated when public registration is false and `Auth__LocalRegistrationKey` is set, and disabled when both public registration and the key are absent.
