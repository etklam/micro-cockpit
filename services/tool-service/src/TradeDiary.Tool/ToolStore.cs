...
static class ToolStore
{
    ...
    private static SavedCalculationResponse ReadSaved(NpgsqlDataReader r)=>new(r.GetGuid(0),r.GetString(1),r.GetInt32(2),JsonDocument.Parse(r.GetString(3)).RootElement.Clone(),JsonDocument.Parse(r.GetString(4)).RootElement.Clone(),r.GetString(5),r.IsDBNull(6)?null:r.GetString(6),r.IsDBNull(7)?null:r.GetString(7),r.GetDateTime(8));
