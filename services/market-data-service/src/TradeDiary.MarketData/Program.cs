...
.Produces(204).ProducesProblem(400).ProducesProblem(403);
...
.Produces<ProviderRunCreatedResponse>(201).ProducesProblem(400).ProducesProblem(403);
...
.Produces(204).ProducesProblem(400).ProducesProblem(403).ProducesProblem(404);
