...
test('mobile Today opens paginated observation history and an Instrument timeline', async () => {
  ...
  await userEvent.type(screen.getByLabelText('Content'), 'breadth')
  await userEvent.click(screen.getByRole('button', { name: 'Search observations' }))
  ...
  expect(screen.getByLabelText('Instrument ID')).toHaveValue('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa')
  Object.defineProperty(window, 'innerWidth', { configurable: true, value: 1024 })
  window.dispatchEvent(new Event('resize'))
})
