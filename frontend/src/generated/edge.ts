...
export type UserSettingsResponse = { "email": string; "displayName": string; "timezone": string; "baseCurrency": string; "appearance": string; "locale": string; "updatedAt": string }
export type UserSettingsWrite = { "displayName": string; "timezone": string; "baseCurrency": string; "appearance": string; "locale": string }
