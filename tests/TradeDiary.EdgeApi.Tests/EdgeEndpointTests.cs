...
public sealed class EdgeAuthorizationTests
{
    ...
    [InlineData("GET", "/api/app/expectations/11111111-1111-1111-1111-111111111111/review-context", "journal:read", HttpStatusCode.OK)]
    ...
    [InlineData("POST", "/api/app/confirmed-patterns", "journal:read", HttpStatusCode.Forbidden)]
    [InlineData("POST", "/api/app/confirmed-patterns", "journal:write", HttpStatusCode.OK)]
    [InlineData("DELETE", "/api/app/confirmed-patterns/11111111-1111-1111-1111-111111111111", "journal:read", HttpStatusCode.Forbidden)]
    [InlineData("DELETE", "/api/app/confirmed-patterns/11111111-1111-1111-1111-111111111111", "journal:write", HttpStatusCode.OK)]
